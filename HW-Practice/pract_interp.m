...
Err1=zeros(maxM-2,1);
Err2=zeros(maxM-2,1);
Time1=zeros(maxM-2,1);
Time2=zeros(maxM-2,1);
Err3=zeros(maxM-2,1);
Time3=zeros(maxM-2,1);
CGrid=(3:1:maxM);
...
for c=CGrid
   ...
   %interpolated grid
    ...
    for j=1:1:20
        ...
        tic;
        F3 = my_optimized_bicubic(f(X0,Y0), {X0,Y0}, {X,Y});
        temp3 = temp3 + toc;
    end
    Time1(i)=temp1/20;
    Time2(i)=temp2/20;
...
%     Time2(c)=toc;
    ...
    err2 = err2/pointsCount;
    err3 = err3/pointsCount;
...
% hold on;
% % plot(CGrid,Err3, "LineWidth",2,"Color",'g');
% legend("Bicubic");
% xlabel('Number of division');
...
% plot(CGrid, Time3,"LineWidth",2,"Color",'g');
legend("Bilinear", "Bicubic");
xlabel('Number of division');
